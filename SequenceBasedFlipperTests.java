...
public class SequenceBasedFlipperTests {
	...
	public void test_GivenStackWithSingleMoveOptionWithDeltaPlusOne_WhenAskedToFindThatOption_ThenReturnsCorrectOption() {
		...
		MockSequencedPancakeStack pStack = new MockSequencedPancakeStack(Arrays.asList(1, 0, 5, 4, 6, 2, 3));
	...
	public void test_GivenStackWithSingleMoveOptionWithDeltaMinusOne_WhenAskedToFindThatOption_ThenReturnsCorrectOption() {
		...
		MockSequencedPancakeStack pStack = new MockSequencedPancakeStack(Arrays.asList(2, 3, 5, 4, 6, 1, 0));
	...
	public void test_GivenStackWithTwoMoveOptionWithDeltaPlusOne_WhenAskedToFindThatOption_ThenReturnsCorrectOption() {
		...
		MockSequencedPancakeStack pStack = new MockSequencedPancakeStack(Arrays.asList(0, 1, 5, 4, 6, 2, 3));
	...
	public void test_GivenStackWithTwoMoveOptionWithDeltaMinusOne_WhenAskedToFindThatOption_ThenReturnsCorrectOption() {
		...
		MockSequencedPancakeStack pStack = new MockSequencedPancakeStack(Arrays.asList(3, 2, 5, 4, 6, 1, 0));
...
//	public void test_GivenStackWithTwoMoveOptionWithDeltaPlusOne_WhenAskedToFindThatOption_ThenReturnsCorrectOption() {
	public void test_match_caseSingleFlipToBase() {
		...
		MockSequencedPancakeStack pStack = new MockSequencedPancakeStack(Arrays.asList(6, 5, 0, 1, 4, 3, 2));
...
//	public void test_GivenStackWithTwoMoveOptionWithDeltaPlusOne_WhenAskedToFindThatOption_ThenReturnsCorrectOption() {
	public void test_match_caseSingleFlipToBaseWithSingleItemSequence() {
		...
		MockSequencedPancakeStack pStack = new MockSequencedPancakeStack(Arrays.asList(6, 0, 1, 5, 4, 3, 2));
...
//	public void test_GivenStackWithTwoMoveOptionWithDeltaPlusOne_WhenAskedToFindThatOption_ThenReturnsCorrectOption() {
	public void test_match_case26_plus() {
		...
		MockSequencedPancakeStack pStack = new MockSequencedPancakeStack(Arrays.asList(0, 1, 5, 4, 6, 3, 2));
		pStack.addSequence(0, 0, 1);
		pStack.addSequence(2, 5, 4);
		pStack.addSequence(4, 6, 6);
		pStack.addSequence(5, 3, 2);
...
//	public void test_GivenStackWithTwoMoveOptionWithDeltaMinusOne_WhenAskedToFindThatOption_ThenReturnsCorrectOption() {
	public void test_match_case26_minus() {
		...
		MockSequencedPancakeStack pStack = new MockSequencedPancakeStack(Arrays.asList(3, 2, 5, 4, 6, 0, 1));
		pStack.addSequence(0, 3, 2);
		pStack.addSequence(2, 5, 4);
		pStack.addSequence(4, 6, 6);
...
//	public void test_GivenStackWithTwoMoveOptionWithDeltaPlusOne_WhenAskedToFindThatOption_ThenReturnsCorrectOption() {
	public void test_match_case45_plus() {
		...
		MockSequencedPancakeStack pStack = new MockSequencedPancakeStack(Arrays.asList(1, 0, 5, 4, 3, 2));
		pStack.addSequence(0, 1, 0);
		pStack.addSequence(2, 5, 4);
...
//	public void test_GivenStackWithTwoMoveOptionWithDeltaMinusOne_WhenAskedToFindThatOption_ThenReturnsCorrectOption() {
	public void test_match_case45_minus() {
		...
		MockSequencedPancakeStack pStack = new MockSequencedPancakeStack(Arrays.asList(2, 3, 5, 4, 0, 1));
		pStack.addSequence(0, 2, 3);
		pStack.addSequence(2, 5, 4);
...
//	public void test_GivenStackWithTwoMoveOptionWithDeltaPlusOne_WhenAskedToFindThatOption_ThenReturnsCorrectOption() {
	public void test_flip_caseSingleFlipToBase() {
		...
		MockSequencedPancakeStack expectedStack = new MockSequencedPancakeStack(Arrays.asList(2, 3, 4, 1, 0, 5, 6));
...
//	public void test_GivenStackWithTwoMoveOptionWithDeltaMinusOne_WhenAskedToFindThatOption_ThenReturnsCorrectOption() {
	public void test_flips_Case18() {
		...
		MockSequencedPancakeStack expectedStack = new MockSequencedPancakeStack(Arrays.asList(6, 4, 5, 0, 1, 2, 3));
...
//	public void test_GivenStackWithTwoMoveOptionWithDeltaPlusOne_WhenAskedToFindThatOption_ThenReturnsCorrectOption() {
	public void test_flips_Case18_Plus() {
		...
		MockSequencedPancakeStack expectedStack = new MockSequencedPancakeStack(Arrays.asList(6, 4, 5, 3, 2, 1, 0));
		expectedStack.addSequence(1, 4, 5);
		expectedStack.addSequence(0, 6, 6);
...
//	public void test_GivenStackWithTwoMoveOptionWithDeltaMinusOne_WhenAskedToFindThatOption_ThenReturnsCorrectOption() {
	public void test_flips_Case26_minus() {
		...
		MockSequencedPancakeStack expectedStack = new MockSequencedPancakeStack(Arrays.asList(5, 4, 6, 0, 1, 2, 3));
...
//	public void test_GivenStackWithTwoMoveOptionWithDeltaPlusOne_WhenAskedToFindThatOption_ThenReturnsCorrectOption() {
	public void test_flips_Case26_Plus() {
		...
		MockSequencedPancakeStack expectedStack = new MockSequencedPancakeStack(Arrays.asList(5, 4, 6, 3, 2, 1, 0));
		expectedStack.addSequence(0, 5, 4);
		expectedStack.addSequence(2, 6, 6);
		expectedStack.addSequence(3, 3, 0);
		expectedStack.setFlipCount(2);
...
//	public void test_GivenStackWithTwoMoveOptionWithDeltaMinusOne_WhenAskedToFindThatOption_ThenReturnsCorrectOption() {
	public void test_flips_Case45_minus() {
		...
		MockSequencedPancakeStack expectedStack = new MockSequencedPancakeStack(Arrays.asList(5, 4, 3, 2, 1, 0));
		expectedStack.addSequence(0, 5, 4);
...
//	}
	...
	public void test_GivenTwoEqualStacks_WhenEqualsCalled_ThenReturnsTrue() {
		...
		MockSequencedPancakeStack pStack = new MockSequencedPancakeStack(Arrays.asList(1, 0, 5, 4, 6, 3, 2));
		pStack.addSequence(0, 1, 0);
		pStack.addSequence(2, 5, 4);
		pStack.addSequence(4, 6, 6);
		pStack.addSequence(5, 3, 2);
				
		MockSequencedPancakeStack expectedStack = new MockSequencedPancakeStack(Arrays.asList(1, 0, 5, 4, 6, 3, 2));
		...
		System.out.println("expectedStack: " + expectedStack);
...
//	public void test_GivenStack_WhenAskedToFlip_ThenSpotsCorrectFlipAndMakesCorrectFlip() {
	public void test_One() {
		...
		MockSequencedPancakeStack expectedStack = new MockSequencedPancakeStack(Arrays.asList(6, 1, 0, 5, 4, 3, 2));
